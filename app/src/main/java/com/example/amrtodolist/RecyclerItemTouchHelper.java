...
public class RecyclerItemTouchHelper extends ItemTouchHelper.SimpleCallback {
    ...
    @Override
    public void onChildDraw(Canvas canvas, RecyclerView recyclerView, RecyclerView.ViewHolder viewHolder, float dX, float dY, int actionState, boolean isCurretlyActive){
        super.onChildDraw(canvas,recyclerView,viewHolder,dX,dY,actionState,isCurretlyActive);
        ...
        if(dX>0){
            ...
            background = new ColorDrawable(R.color.red);
        }
